...
var SplitButtonComponent = /** @class */ (function (_super) {
    ...
    SplitButtonComponent.propDecorators = {
        ...
        button: [{ type: core_1.ViewChild, args: ['button', { static: true },] }],
        arrowButton: [{ type: core_1.ViewChild, args: ['arrowButton', { static: true, read: core_1.ElementRef },] }],
        popupTemplate: [{ type: core_1.ViewChild, args: ['popupTemplate', { static: true },] }],
        containerRef: [{ type: core_1.ViewChild, args: ['container', { read: core_1.ViewContainerRef, static: true },] }],
